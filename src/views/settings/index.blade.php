                ...
                {!! Form::open(['route' => 'settings.update', 'class' => 'form-horizontal']) !!}
                    <div class="box-body">
                        ...
                        <ul class="nav nav-tabs">
                            ...
                            <li><a href="#business" data-toggle="tab">Business Settings</a></li>
                            <li><a href="#hours" data-toggle="tab">Office Hours Settings</a></li>
                            <li><a href="#social" data-toggle="tab">Social Settings</a></li>
                        </ul>
